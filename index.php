...
<body>
    ...
    <!-- Start Registration -->
    <?php require_once "userRegistration.php"; ?>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            <img src="images/avtar2.jpeg" alt="avt1" class="img-fluid" style="border-radius: 100px;">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            <img src="images/avtar3.jpeg" alt="avt1" class="img-fluid" style="border-radius: 100px;">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            <img src="images/avtar4.jpeg" alt="avt1" class="img-fluid" style="border-radius: 100px;">
    ...
    <div class="container">
        ...
        <div class="row py-3">
            ...
            <div class="col-md-6 text-right">
                ...
                <small>Designed by Faizan Ahmad Khan &copy; 2019.</small>
