...
<div class="col-sm-4 mb-5">
    ...
    <?php 
    $sql = "SELECT id, request, request_desc, 
    request_date FROM submit_request";
    ...
    // after assigning work we will delete data from submit_request table by pressing close button
    if(isset($_POST['close'])){
    $sql = "DELETE FROM submit_request WHERE id = {$_POST['id']}";
